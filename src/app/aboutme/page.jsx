...
function Aboutme() {
  return (
    ...
    <div className='about-container'>
        ...
        <Image src="/hero_img-1.png" width={600} height={500} style={{borderRadius:10}} />
        </div>
    </div>
    <div className='about-container'>
      <div className='Text-container'>
      <Image src="/about_shap_bg.png" width={300} height={300} style={{borderRadius:10}} />
    ...
    <div>
        ...
        <div className='enterprenur-philosophy-container'>
          <div className='enterprenur-philosophy'>
             ...
             <Image src="/awt-logo.png" width={200} height={100} style={{borderRadius:10}} />
...
At AWT, we understand that in today’s digital age, having a strong  online presence is crucial for any business. That’s why we offer a  range of services to help our clients succeed in the digital realm..</p>
    ...
    <div className='inspiration-section'>
      ...
      <Image className='img' src="/inspiration.png" width={350} height={250} style={{borderRadius:20}} />
      <div>
        <h2>Bryant Mcgill</h2>
      ...
      <div style={{display:'flex',flexDirection:'column',width:400}}>
      <Image className='img' src="/inspiration02.png" width={350} height={250} style={{borderRadius:20}} />
      <div>
      ...
      <div style={{display:'flex',flexDirection:'column',width:400}}>
      <Image className='img' src="/inspiration03.png" width={350} height={250} style={{borderRadius:20}} />
      <div>
        <h2>Grant Cardone</h2>
      <p style={{lineHeight:2}}>
